...
const benefits = [
  ...
  "Rolety nadstawne i podtynkowe",
  "Izolacja termiczna i akustyczna",
  "Ochrona antywłamaniowa",
  "Sterowanie elektryczne i solarne",
  "Automatyka czasowa i pogodowa",
  "Moskitiery w zestawie",
];

export default function OfferRollers() {
  return (
    <Layout>
      <section className="relative py-24 bg-graphite overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <img src={rollersImg} alt="" className="w-full h-full object-cover" />
        </div>
        <div className="container relative">
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-background mb-6">
            Rolety i osłony zewnętrzne
          </h1>
          <p className="text-xl text-background/80 max-w-2xl mb-8">
            Prywatność, izolacja i bezpieczeństwo. Rolety zewnętrzne 
            do każdego typu okien i budynku.
          </p>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <img src={rollersImg} alt="Rolety zewnętrzne" className="rounded-xl shadow-elevated relative" />
            </div>
